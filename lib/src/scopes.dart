...
class SteemApiScope {
  ...
  static const SteemApiScope commentDelete = const SteemApiScope('comment_delete');

  /// A scope allowing an application to add options for a post or comment
  static const SteemApiScope commentOptions = const SteemApiScope('comment_options');
  ...
  static const SteemApiScope claimRewardBalance = const SteemApiScope('claim_reward_balance');
